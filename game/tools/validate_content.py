...
def v_condition(c, path):
    ...
    elif "declaredTargetsSelf" in c or "eventHasTag" in c or "eventStatusKind" in c or "eventSourceId" in c or "eventTeamIsSelf" in c or "eventSourceSummonedBySelf" in c or "eventRedirectedToSelf" in c or "eventHidden" in c or "chance" in c:
        pass
    elif "and" in c:
